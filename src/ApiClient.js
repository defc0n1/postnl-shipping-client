...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PostnlShippingClient.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api-sandbox.postnl.nl/shipment
     */
    this.basePath = 'https://api-sandbox.postnl.nl/shipment'.replace(/\/+$/, '');
