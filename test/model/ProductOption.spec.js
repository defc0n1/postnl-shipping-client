...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostnlShippingClient.ProductOption();
  });
  ...
  describe('ProductOption', function() {
    it('should create an instance of ProductOption', function() {
      ...
      //var instane = new PostnlShippingClient.ProductOption();
      //expect(instance).to.be.a(PostnlShippingClient.ProductOption);
    });

    it('should have the property characteristic (base name: "Characteristic")', function() {
      // uncomment below and update the code to test the property characteristic
      //var instane = new PostnlShippingClient.ProductOption();
