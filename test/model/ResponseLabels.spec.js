...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostnlShippingClient.ResponseLabels();
  });
  ...
  describe('ResponseLabels', function() {
    it('should create an instance of ResponseLabels', function() {
      // uncomment below and update the code to test ResponseLabels
      //var instane = new PostnlShippingClient.ResponseLabels();
      //expect(instance).to.be.a(PostnlShippingClient.ResponseLabels);
    });
